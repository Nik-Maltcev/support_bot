...
This is a Telegram bot that uses OpenAI's GPT model to act as a technical support specialist. It is configured using environment variables, making it easy to deploy to platforms like Railway.
...
To run the bot locally, you need to set the same environment variables (`TELEGRAM_TOKEN` and `OPENAI_API_KEY`) in your terminal before running the script.
